...
namespace LWD_DataProcess
{
    public partial class TDP : Form
    {
        ...
        private delegate void SetPos(int ipos,ProgressBar pb);
        private void SetTextMessage(int ipos,ProgressBar pb)
        {
        ...
        private void comboBox_LogMethod_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (this.comboBox_LogMethod.SelectedIndex)
            {
                case 0:
                    this.LM = LogMethod.LWD;
                    break;
                case 1:
                    this.LM = LogMethod.LAD;
                    break;
                default:
                    this.LM = LogMethod.LWD;
                    break;
